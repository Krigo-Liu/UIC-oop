	...
	public static void main(String[] args) {
        ...
        while (begin < end) {
            if (chars[begin] == chars[end]) {		// Determine if words are consistent
                ...
                System.out.println("\""+ sentence + "\"" + " is not a Palindrome."); // Determine if the sentence is not a palindrome and stop loop.
                break;
            }
            System.out.println("\""+ sentence + "\"" + " is a Palindrome.");		// Determine if the sentence is a palindrome and stop loop.
            break;
        }
